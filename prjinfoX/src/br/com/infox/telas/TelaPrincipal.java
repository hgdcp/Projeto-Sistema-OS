...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblFotSis = new javax.swing.JLabel();
        ...
        lblFotSis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/letra-x-240.jpg"))); // NOI18N
    ...
    private void menRelCliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menRelCliActionPerformed
        ...
        if(confirma == JOptionPane.YES_OPTION){
            ...
            try {
                ...
                JasperPrint print = JasperFillManager.fillReport("C:/Users/henri/Desktop/reports/clientes.jasper", null, conexao);
    ...
    private void MenRelSerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenRelSerActionPerformed
        ...
        if(confirma == JOptionPane.YES_OPTION){
            ...
            try {
                // usando a classe JasperPrint para preparar a emissão de um relatório
                JasperPrint print = JasperFillManager.fillReport("C:/Users/henri/Desktop/reports/servicos.jasper", null, conexao);
                // a linha abaixo exibe o relatório através  da classe JasperViewer
                JasperViewer.viewReport(print, false);
            } catch (Exception e) {
                JOptionPane.showMessageDialog(null, e);
    ...
    private javax.swing.JLabel lblFotSis;
